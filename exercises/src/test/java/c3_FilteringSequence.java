 ...
 * Read first:
 * <p>
 * <a href="https://projectreactor.io/docs/core/release/reference/#which.filtering">...</a>
 * <p>
...
class c3_FilteringSequence extends FilteringSequenceBase {
    ...
    void girls_are_made_of_sugar_and_spice() {
        Flux<String> shortListed = popular_girl_names_service()
            .filter(girlName -> girlName.length() <= 4);
    ...
    void economical() {
        Flux<String> items = duplicated_records_service()
            ...
            .flatMapIterable(element -> element);
     ...
     * if you pull more than needed, you may brake it.
     * <p>
