...
/**
 * In this chapter we are going to cover fundamentals of how to create a sequence. At the end of this chapter we will
 * tackle more complex methods like generate, create, push, and we will meet them again in following chapters like Sinks
 * and Backpressure.
 * <p>
 * Read first:
 * <p>
 * <a href="https://projectreactor.io/docs/core/release/reference/#which.create">...</a>
 * <a href="https://projectreactor.io/docs/core/release/reference/#producing">...</a>
 * <a
 * href="https://projectreactor.io/docs/core/release/reference/#_simple_ways_to_create_a_flux_or_mono_and_subscribe_to_it">...</a>
 * <p>
 * Useful documentation:
 * <p>
 * <a href="https://projectreactor.io/docs/core/release/reference/#which-operator">...</a>
 * <a href="https://projectreactor.io/docs/core/release/api/reactor/core/publisher/Mono<a href=".html">...</a>
 * ">* https://projectreactor.io/docs/core/release/api/reactor/core/p</a>ublisher/Flux.html
 *
...
class c5_CreatingSequence {
    ...
    /**
     * Create Callable that increments the counter and returns the counter value, and then use `repeat()` operator to
     * create Flux that emits values from 0 to 10.
     */
    @Test
    void repeat() {
     ...
     * <p>
     * Answer: - What is difference between `generate` and `create`? - What is difference between `create` and `push`?
     */
    @Test
